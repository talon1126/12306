...
package com.talon.index12306.ticketservice.remote;
...
import com.talon.index12306.ticketservice.dto.req.TicketOrderItemQueryReqDTO;
 ...
 */
@FeignClient(value = "index12306-order${unique-name:}-service", url = "http://127.0.0.1:9003")
