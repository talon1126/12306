...
package com.talon.index12306.ticketservice.common.constant;
...
public final class RedisKeyConstant {
     ...
     * 站点余票查询分布式锁Key
     */
    public static final String LOCK_TRAIN_STATION_REMAINING_TICKET = "index12306-ticket-service:lock:train_station_remaining_ticket:";
     ...
     * 车厢余票查询分布式锁Key
     */
    public static final String LOCK_TRAIN_STATION_CARRIAGE_REMAINING_TICKET = "index12306-ticket-service:lock:train_station_carriage_remaining_ticket:";
