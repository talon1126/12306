...
package com.talon.index12306.orderservice.dao.algorithm;
...
public class OrderCommonTableComplexAlgorithm implements ComplexKeysShardingAlgorithm {
     ...
     * @param shardingValue ShardingSphere 封装的分片条件
     *
     */
    @Override
    public Collection<String> doSharding(Collection availableTargetNames, ComplexKeysShardingValue shardingValue) {
        //SQL: select * from t_order where user_id = '123456789'
        //shardingValue.getColumnNameAndShardingValuesMap() = {user_id=["123456789"]}
